...
| 후보 | Validation Accuracy | Test Accuracy | Test Macro F1 | 정상 클래스 |
|---|---:|---:|---:|---|
| Hair | 0.7771565318107605 | 0.7883386581469649 | 0.7885764577048346 | 없음 |
| Web Skin | 0.796 | 0.8825 | 0.8813822927981046 | 있음 |
| Skin | 0.982 | 0.9871428571428571 | 0.9871314132317626 | 없음 |
...
| `normal_class_included` | Hair·Skin false, Web Skin true |
...
| 평가 사례 | 확인할 내용 |
|---|---|
| Hair·Skin 결과 | 정상 클래스가 없는데 ‘정상/질환 없음’을 만들어 내지 않는가 |
| Web Skin 정상 결과 | 정상 점수를 모든 질환 부재로 단정하지 않는가 |
