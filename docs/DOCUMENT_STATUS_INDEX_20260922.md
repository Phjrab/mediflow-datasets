...
기준일: 2026-09-22. 파일을 이동하거나 삭제하지 않고, 현재 기준과 과거 기록의 역할을 구분한다.

## 1. 현재 기준 문서

| 우선순위 | 문서 | 용도 |
|---:|---|---|
| 1 | `research/MEDIFLOW_PROJECT_MASTER_SUMMARY_20260922.md` | 프로젝트 전체 현황과 최종 결과 |
| 2 | `research/PAPER_EXPERIMENTS_FINAL_ANALYSIS_20260922.md` | 논문 기반 방법의 이유·적용·결과 분석 |
...
현재 수치와 결론은 2026-09-22 master summary를 우선한다.
